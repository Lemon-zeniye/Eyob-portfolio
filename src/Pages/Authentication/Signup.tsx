...
const Signup = () => {
  ...
  return (
    <div className="flex flex-row justify-between lg:h-screen overflow-y-hidden">
      <div className="lg:w-1/2 hidden bg-primary lg:flex items-center justify-center">
      ...
      <div className="lg:w-1/2 w-full flex flex-col py-4 lg:py-14 px-8r justify-between bg-white">
